  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="font-display text-4xl sm:text-5xl tracking-wider text-white mb-10">Cookie Policy</h1>

        <div className="space-y-8 text-gslc-text text-sm leading-relaxed">
          <section>
            <h2 className="font-display text-xl tracking-wider text-white mb-3">What Are Cookies?</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-white mb-3">Cookies We Use</h2>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b border-gslc-border/50">
                    <td className="py-3 pr-4 text-white font-mono text-xs">gslc-cookie-consent</td>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-white mb-3">Third-Party Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-white mb-3">Managing Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-white mb-3">Changes to This Policy</h2>
            <p>
