  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="font-display text-4xl sm:text-5xl tracking-wider text-gslc-gold mb-10">Impressum</h1>

        <div className="space-y-8 text-gslc-text text-sm leading-relaxed">
          <section>
            <h2 className="font-display text-xl tracking-wider text-gslc-red mb-3">Information pursuant to § 5 TMG</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-gslc-red mb-3">Responsible for Content (§ 55 Abs. 2 RStV)</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-gslc-red mb-3">Dispute Resolution</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-gslc-red mb-3">Liability for Content</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl tracking-wider text-gslc-red mb-3">Liability for Links</h2>
            <p>
